...
Two middleware functions are provided by default in the `clearway.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `clearway.handler` namespace to manage the enabled middleware.
